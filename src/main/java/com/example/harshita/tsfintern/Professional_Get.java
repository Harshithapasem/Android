...
public class Professional_Get extends AppCompatActivity {
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professional__get);
        Intent in=getIntent();
    ...
    private void fetchdata(String id) {
        ...
        String URL=Constant.BASE_URL+"/user/professionaldetail/"+id;
        ...
        JsonObjectRequest request=new JsonObjectRequest(Request.Method.POST, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(Professional_Get.this, "Inserted successfully" ,Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest request1=new JsonObjectRequest(Request.Method.PUT, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    Toast.makeText(Professional_Get.this, "UPDATED successfully" ,Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
