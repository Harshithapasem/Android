...
public class Education_Act extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        certi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ivcerti=new ImageView(Education_Act.this);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==Pic_image && resultCode==RESULT_OK)
        {
            ...
            try {
                ...
                queue= Volley.newRequestQueue(Education_Act.this);
                String URL=Constant.BASE_URL+"/user/educationdetail/certificate";
                ...
                JsonObjectRequest request=new JsonObjectRequest(Request.Method.POST, URL, parameters, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Education_Act.this, ""+data, Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest request=new JsonObjectRequest(Request.Method.POST, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(Education_Act.this, "Inserted successfully" ,Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
        ...
        JsonObjectRequest request1=new JsonObjectRequest(Request.Method.PUT, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    startyr.setText(startYear);
                    endyr.setText(endYear);
                    Toast.makeText(Education_Act.this, "UPDATED successfully" ,Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
