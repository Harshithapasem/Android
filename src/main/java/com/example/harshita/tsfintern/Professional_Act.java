...
public class Professional_Act extends AppCompatActivity {
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_professional_);
        Intent in=getIntent();
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in=new Intent(Professional_Act.this,Professional_Get.class);
                in.putExtra("id",id);
                startActivity(in);
            }
        });
