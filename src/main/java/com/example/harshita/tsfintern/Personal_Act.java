...
public class Personal_Act extends AppCompatActivity {
    RequestQueue queue;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(requestCode==Pic_image && resultCode==RESULT_OK)
        {
            ...
            try {
                ...
                queue= Volley.newRequestQueue(Personal_Act.this);
                String URL=Constant.BASE_URL+"/user/personaldetail/pp/post";
                ...
                JsonObjectRequest request=new JsonObjectRequest(Request.Method.POST, URL, parameters, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            Toast.makeText(Personal_Act.this, ""+data, Toast.LENGTH_SHORT).show();
        ...
        JsonObjectRequest request=new JsonObjectRequest(Request.Method.POST, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    ...
                    Toast.makeText(Personal_Act.this, "Inserted successfully" ,Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
        ...
        JsonObjectRequest request1=new JsonObjectRequest(Request.Method.PUT, URL, parameters, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    links.setText(slinks);
                    skills.setText(sskills);
                    Toast.makeText(Personal_Act.this, "UPDATED successfully" ,Toast.LENGTH_SHORT).show();
                } catch (JSONException e) {
                    e.printStackTrace();
                }
            }
