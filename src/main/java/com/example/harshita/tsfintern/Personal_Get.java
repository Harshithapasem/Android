...
public class Personal_Get extends AppCompatActivity {
    RequestQueue queue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal__get);
        ...
        edit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in=new Intent(Personal_Get.this,Personal_Act.class);
                in.putExtra("id",id);
    ...
    private void fetchPhoto(String id) {
        ...
        ImageRequest imageRequest=new ImageRequest(URL, new Response.Listener<Bitmap>() {
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(Personal_Get.this, "Error found"+error, Toast.LENGTH_SHORT).show();
            }
        });
